...
HD_PWD='D:/MMU/Verilog_Implementation/MMU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Memory_Protection.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Memory_Protection.tcl -notrace
